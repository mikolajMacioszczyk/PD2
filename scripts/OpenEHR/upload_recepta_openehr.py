...
default_composition_file_path = f"{DATA_DIRECTORY_PATH}recepta/OpenEHR/{default_composition_file_name}"

def upload_recepta_full(pesel = default_pesel, composition_file_path = default_composition_file_path):
