...
from FHIR.queries_definitions import create_get_full_iniekcja_batch_bundle, create_get_allergy_reaction_batch_bundle
...
def get_allergy_reaction(medication_administration_id, patient_id):
    resource_bundle = send_batch_request(create_get_allergy_reaction_batch_bundle(patient_id, medication_administration_id))
